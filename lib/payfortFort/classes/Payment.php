    ...
    public function handleFortResponse($fortParams = array(), $responseMode = 'online', $integrationType = 'redirection', $responseSource = '')
    {
        try {
            ...
            if (empty($responseParams)) {
                ...
                Mage::throwException($responseMessage);
            }
            ...
            $notIncludedParams = array('signature', 'route', '___store');
            ...
            if (substr($responseCode, 2) == '000') {
                if ($responseMode == 'online' && $responseSource != 'h2h' && ( ( ($paymentMethod == PAYFORT_FORT_PAYMENT_METHOD_CC || $paymentMethod == PAYFORT_FORT_PAYMENT_METHOD_INSTALLMENTS) && ($integrationType == PAYFORT_FORT_INTEGRATION_TYPE_MERCAHNT_PAGE || $integrationType == PAYFORT_FORT_INTEGRATION_TYPE_MERCAHNT_PAGE2))) ) {
            ...
            $this->pfHelper->refillCart($this->pfOrder->getLoadedOrder());
